...
var _uncomfortable = require('./uncomfortable');

var _uncomfortable2 = _interopRequireDefault(_uncomfortable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var loaders = [_cat2.default, _yak2.default, _fomo2.default, _uncomfortable2.default];
        ...
        packages.forEach(function (name) {
          switch (name) {
            case 'cat':
              ...
              break;
            case 'yak':
              queue.push(_yak2.default.fetch());
              break;
            case 'fomo':
              queue.push(_fomo2.default.fetch());
              break;
            case 'uncomfortable':
              queue.push(_uncomfortable2.default.fetch());
              break;
            default:
              break;
          }
